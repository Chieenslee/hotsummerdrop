<div align="center">
  <h1>🎮 HOT Drop Rush - Auto Hack (Chrome Extension)</h1>
  <p><i>Tiện ích mở rộng tự động HACK Mini-Game PUBG HOT Summer Drop</i></p>
...
- **Jetpack Mode (Lơ lửng):** Trọng lực bằng 0, nhảy lên là lơ lửng trên không trung.
- **Lao Xuống Nhanh:** Nhấn giữ **`S`** hoặc **`Mũi tên Xuống (↓)`** để cắm đầu xuống đất ngay lập tức.
- **Siêu Farm Điểm (AFK):** Tốc độ NPC rớt xuống cực nhanh (100x), chạm đất là tính điểm luôn (Cộng 100,000 điểm/mỗi con). Lên Top 1 Server chỉ trong vài giây!
...
👉 **[Bấm vào đây để tải về bản HACK (PUBG_HOT_Drop_Hack.zip)](https://raw.githubusercontent.com/Chieenslee/hotsummerdrop/main/PUBG_HOT_Drop_Hack.zip)**

1. **Giải nén file:** Giải nén file `PUBG_HOT_Drop_Hack.zip` vừa tải về ra một thư mục.
...
4. **Trải nghiệm:** Vào trang sự kiện PUBG, đợi 2 giây là hack tự kích hoạt! Đóng game cũ lại và ấn Play Mini-Game.
...
4. Mở file [**`hack.js`**](hack.js) trên trang Github này, **copy toàn bộ đoạn code** trong đó và dán vào tab Console, sau đó nhấn `Enter`.
5. Đóng mini-game đang mở sẵn (nhấn dấu `X`).
6. Bấm nút **Play Mini-Game** để thưởng thức bản hack!
...
---
*Nếu thấy thú vị và lên được Top 1, đừng quên cho mình xin 1 **Star ⭐** và **Follow** GitHub nhé! Cảm ơn các bạn rất nhiều! ❤️*
